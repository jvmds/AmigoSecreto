...
public static class UserEndpoints
{
    ...
    {
        app.MapPost("/users", async (UserInputDto userInput, AmigoSecretoContext _amigoSecretoContext, IMapper _mapper) =>
        {
        ...
        app.MapGet("/users/{userId:int}", async (int userId, AmigoSecretoContext _amigoSecretoContext, IMapper _mapper) =>
        {
